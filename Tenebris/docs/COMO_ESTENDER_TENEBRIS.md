...
2. Aguarde o workflow **Build Tenebris DLL**.
3. Corrija qualquer erro até a execução ficar verde.
4. Abra a execução e baixe o artifact `Tenebris-Windows-x64-...`.
5. Dentro do ZIP estará `Tenebris.dll`.
