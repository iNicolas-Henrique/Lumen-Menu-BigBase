...
Após resolver conflitos ou fazer uma fusão manual, execute:

```bash
python Lumen/tools/verify_frontend_structure.py
```

A verificação detecta implementações duplicadas do menu/editor, chaves desbalanceadas e o retorno acidental do sistema antigo de cores.
