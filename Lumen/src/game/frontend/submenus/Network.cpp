...
namespace YimMenu::Submenus
{
    ...
    Network::Network() :
        Submenu::Submenu("Rede")
    {
        auto session              = std::make_shared<Category>("Sessao");
        auto spoofing             = std::make_shared<Category>("Mascaramento");
        auto database             = std::make_shared<Category>("Banco de jogadores");
